...
export const TREATMENTS: Treatment[] = [
  {
    ...
    description: "Restore missing teeth with advanced titanium implants designed for long-term comfort and function.",
    description_bn: "দীর্ঘমেয়াদী আরাম এবং কার্যকারিতা নিশ্চিত করে আধুনিক টাইটানিয়াম ইমপ্ল্যান্টস ব্যবহার করে অনুপস্থিত দাঁত পুনরুদ্ধার করুন।",
    image: "https://picsum.photos/seed/implant-procedure/800/600",
    benefits: [
  ...
  },
  {
    ...
    description: "Discreet, removable aligners for straightening teeth without traditional braces.",
    description_bn: "প্রচলিত ব্রেস ছাড়া দাঁত সোজা করার জন্য সূক্ষ্ম, সরানো যায় এমন অ্যালাইনার।",
    image: "https://picsum.photos/seed/clear-aligner-dental/800/600",
    benefits: [
  ...
  },
  {
    ...
    category: "Cosmetic",
    category_bn: "কসমেটিক",
    description: "Enhance your smile with professional cosmetic treatments tailored to your aesthetic goals.",
    description_bn: "আপনার হাসির সৌন্দর্য আপনার নান্দনিক লক্ষ্য অনুযায়ী পেশাদার কসমেটিক চিকিৎসার মাধ্যমে উন্নত করুন।",
    image: "https://picsum.photos/seed/cosmetic-smile-teeth/800/600",
    benefits: [
      "Improved appearance",
  ...
  },
  {
    ...
    description_bn: "আপনার হাসি উজ্জ্বল করতে এবং দাঁতের দাগ দূর করতে পেশাদার উজ্জ্বন চিকিৎসা।",
    image: "https://picsum.photos/seed/teeth-whitening-bright/800/600",
    benefits: [
  ...
  },
  {
    ...
    description: "Save natural teeth with advanced root canal therapy using modern techniques.",
    description_bn: "আধুনিক পদ্ধতি ব্যবহার করে রুট ক্যানাল থেরাপি দিয়ে প্রাকৃতিক দাঁত বাঁচান।",
    image: "https://picsum.photos/seed/root-canal-tooth/800/600",
    benefits: [
  ...
  },
  {
    ...
    image: "https://picsum.photos/seed/pediatric-kids-teeth/800/600",
    benefits: [
      "Preventive care",
      "Early detection",
  ...
  },
  {
    ...
    image: "https://picsum.photos/seed/gum-periodontal-care/800/600",
    benefits: [
  ...
  },
  {
    ...
    image: "https://picsum.photos/seed/smile-makeover-transform/800/600",
    benefits: [
  ...
  },
  {
    ...
    image: "https://picsum.photos/seed/dental-veneer-procedure/800/600",
    benefits: [
      "Natural appearance",
      "Stain resistant",
